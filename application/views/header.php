<?php
    ...
    //echo '<link href="static/css/font-awesome.css" rel="stylesheet">';
    ...
    echo '<link href="'.APPPATH.'static/css/style.css" rel="stylesheet" media="screen">';
    echo '<link rel="shortcut icon" href="'.APPPATH.'static/images/favicon.ico" type="image/x-icon">';
