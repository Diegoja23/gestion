...
class Common
{
     ...
     public static $extensionToType = array (
   ...
   public static function fromUsrToSqlDate($date, $delimiter = "-")
   {
    ...
    public static function standarType($extToConvert)
    {
        $extToType = self::$extensionToType;
        $standarType = array_search($extToConvert, $extToType);  // $clave = 1;
        return $standarType;
