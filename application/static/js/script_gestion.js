...
function agregar_fila_adjunto_cliente(id_adjunto,nombre_adjunto,tipo){
    var fila = '<tr id="' + id_adjunto + '" tipo=' + tipo + '><td class="adjunto_mostrado_tramite"><i class="adjunto_tramite fa fa-paperclip fa-lg"></i></td><td class="adjunto_mostrado_tramite">' + nombre_adjunto + '</td><td><p><i title="Ver adjunto" class="btn_ver_adjunto_de_un_cliente fa fa-eye fa-lg"></i>&nbsp;&nbsp;<i title="Eliminar" class="btn_eliminar_adjunto_de_un_cliente fa fa-ban fa-lg"></i></p></td></tr>';
...
function agregarTipoGestion2(){
    ...
    if(validarDatosTipoGestion(descripcion_tipo_gestion,div_error)){
...
function validarDatosTipoGestion(descripcion_tipo_gestion,div_error){
    var retorno = true;
    if(validarString(descripcion_tipo_gestion)){
        mensajeValidacion(div_error,'Debe llenar la <em>descripción</em>');
        retorno = false;
    } 
    return retorno;
...
function guardarTipoTramite(){
    var div_error = '#retorno_ajax_plantillas';
    $(div_error).html('');
...
function validarDatosTipoTramite(descripcion,div_error){
    var retorno = true;
    if(validarString(descripcion)){
        mensajeValidacion(div_error,'Debe llenar la <em>descripción</em>');
        retorno = false;
...
function guardarUsuario(){
    var div_error = '#retorno_borrado_usuario';
    $(div_error).html('');
...
function validarDatosUsuario(nombre_usuario,apellido_usuario,email_usuario,pass_usuario,repeat_pass_usuario,div){
    ...
    if(validarString(apellido_usuario)){
        mensajeValidacion(div,'<em>Apellido</em> no válido');
        retorno = false;
    }
